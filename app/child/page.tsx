...
export default function Dashboard() {
  ...
  return (
    <div className="w-full h-screen relative flex overflow-hidden bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/nature_bg.png')" }}>
      {/* Premium Overlay */}
      <div className="absolute inset-0 bg-white/60 backdrop-blur-[3px] z-0"></div>
      {/* Sidebar */}
