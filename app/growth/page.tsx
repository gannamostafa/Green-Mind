...
<div className="relative z-10 flex w-full h-screen">
  <Sidebar />
        ...
        {/* Main */}
        <div className={`${poppins.className} flex-1 relative`}>
          ...
          <div className="absolute top-5 right-10 flex gap-4 items-center z-50">
            ...
            <div className="relative">
              ...
              {openDropdown && (
                <div className="absolute right-0 mt-3 w-40 bg-white rounded-xl shadow-lg p-2">
                  <button 
...
<div className="absolute top-[-3px] left-1/2 -translate-x-1/2 z-30">
  ...
  />
             ...
             <div className="absolute w-full h-full blur-[1px] rounded-full"></div>
...
/> 
          ...
          {currentLevel > 0 && (
            <button
              onClick={prev}
              className="absolute left-[22%] top-1/2 -translate-y-1/2  p-30 rounded-full"
            >
          ...
          {currentLevel < levels.length - 1 && (
            <button
              onClick={next}
              className="absolute right-[22%] top-1/2 -translate-y-1/2  p-30 rounded-full"
            >
          ...
          <div className="absolute bottom-13 left-13 backdrop-blur-md p-4 rounded-2xl w-[500px] bg-white/20 border border-black/20 text-left">
            <h3 className="text-center mb-3 text-black font-bold">
              Care Activities
            </h3>
...
<h3 className="text-center mb-4 font-bold text-xl text-white">
  <span
    ...
    style={{ WebkitTextStroke: "1px #666666" }}
  >
    Tree Care
  </span>
</h3>
  <div className="bg-white/40 p-2 rounded-xl mb-3">
    <p className="font-semibold text-[#3c3c3c]">💧 water 3/5</p>
    <div className="bg-gray-200 h-2 rounded mt-1">
      <div className="bg-blue-400 h-2 w-[60%] rounded"></div>
    </div>
  </div>
  <div className="bg-white/40 p-2 rounded-xl mb-3">
    <p className="font-semibold text-[#3c3c3c]">☀ sunshine 4/5</p>
    <div className="bg-gray-200 h-2 rounded mt-1">
      <div className="bg-yellow-400 h-2 w-[80%] rounded"></div>
    </div>
  </div>
  <div className="bg-white/40 rounded-full px-3 py-2 text-center font-semibold text-[#3c3c3c] cursor-pointer hover:bg-white/60 transition">
    💧 water my tree
  </div>
</div>
