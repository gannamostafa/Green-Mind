      ...
      <div className="relative z-10 flex w-full h-screen">
        ...
        <div className="flex-1 relative">
          ...
          {currentLevel > 0 && (
            <button
              onClick={prev}
              className="absolute left-[32%]  top-1/2 -translate-y-1/2 p-2 rounded-full hover:opacity-80 transition"
            >
          ...
          {currentLevel < levels.length - 1 && (
            <button
              onClick={next}
              className="absolute right-[32%] top-1/2 -translate-y-1/2 p-2 rounded-full transition hover:opacity-80"
            >
