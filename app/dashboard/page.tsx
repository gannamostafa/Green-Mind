...
const moodContent: any = {
  Happy: {
    messages: [
      "سعادتك بتفرحنا! خليك دايمًا مبتسم ومتحمس للتعلم 🌟",
      "استمر في الابتسام، يومك جميل زيك 😊",
      "الفرحة اللي فيك تنور كل اللي حواليك ✨",
      "خليك دايمًا إيجابي واستمتع بكل لحظة 💛",
      "سعيدين إنك مبسوط! كمل طاقتك الحلوة 🎉",
    ],
  ...
  Sad: {
    messages: [
      "متزعلش، إحنا معاك دايمًا ❤️",
      "الحزن شعور طبيعي، وهيمر قريبًا بإذن الله 🌿",
      "أنت مش لوحدك، كل حاجة هتبقى أحسن ✨",
      "خد وقتك واهدأ، كل شيء بيتصلح مع الوقت 💙",
      "ابتسم حتى لو صعب، بكرة أجمل بإذن الله 😊",
    ],
  ...
  Angry: {
    messages: [
      "خد نفس عميق، أنت بطل وهتقدر تتخطى أي حاجة 🧘‍♂️",
      "الغضب شعور طبيعي، لكن حاول تهدي نفسك شوية 🌿",
      "تنفس ببطء وخد وقتك قبل ما تتصرف 💙",
      "أنت أقوى من لحظة الغضب دي، حاول تهدأ ✨",
      "كل شيء هيتحل، بس خليك هادي وفكر براحة 😌",
    ],
  ...
  Calm: {
    title: "هادئ: مزاجك اليوم",
    messages: [
      "خد نفس عميق وابتسم، يومك هيكون هادي ومريح 😌",
      "أنت بخير، خليك هادي واستمتع بيومك 🌿",
      "الهدوء بيبدأ من داخلك، حافظ على سلامك 💙",
      "كل شيء تمام، خليك مسترخي واطمن 🌸",
      "القلب الهادئ يصنع يوم جميل ✨",
    ],
  ...
  Excited: {
    messages: [
      "حماسك رائع! يلا نبدأ مغامرة جديدة النهاردة! 🚀",
      "طاقة عالية جدًا! استمر في الحماس ده 🤩🔥",
      "الحماس اللي عندك هيخليك توصل لأي هدف ✨",
      "يومك مليان طاقة إيجابية، استغلها كويس ⚡",
      "رائع! استمر في الاستمتاع بكل لحظة 🎉",
    ],
  ...
  Focused: {
    messages: [
      "تركيزك هو سر نجاحك، برافو عليك! 🎯",
      "استمر في التركيز، أنت تتحسن كل يوم 🚀",
      "عقلك قوي لما تركز على هدفك 💡",
      "التركيز بيخليك توصل لأحلامك أسرع 🧠✨",
      "رائع! استمر في إبعاد أي مشتتات 👏",
    ],
  ...
  Kind: {
    messages: [
      "طيبتك بتخلي العالم أجمل، خليك دايمًا لطيف! 😁",
      "اللطف قوة كبيرة بتخليك محبوب من الجميع 💖",
      "استمر في نشر الابتسامة والاحترام 🌸",
      "تصرفاتك اللطيفة بتأثر في اللي حواليك بطريقة جميلة ✨",
      "خليك دايمًا مصدر خير وسعادة للآخرين 🌈",
    ],
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pb-10 items-stretch text-left">
            ...
            <TodaysActivity
              scanData={[
                {
                  name: "done",
                  value: progress.scansCount,
                },
                {
                  name: "left",
                  value: 10 - progress.scansCount,
                },
              ]}
